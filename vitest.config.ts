...
// `**/.claude/**` keeps agent worktrees under .claude/worktrees/ (whole nested repo
// copies) from being collected into the main suite.
export default defineConfig({
  test: { exclude: ['test-e2e/**', 'node_modules/**', 'dist/**', 'web/dist/**', '**/.claude/**'] },
});
